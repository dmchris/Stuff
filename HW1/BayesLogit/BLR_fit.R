...
#	header=TRUE, sep=",")
data <- read.table(sprintf("jihao@gauss.cse.ucdavis.edu/STA250/Stuff/HW1/BayesLogit/data/blr_data_%d.csv",
...
write.table(BetaPercentile, sprintf("jihao@gauss.cse.ucdavis.edu/STA250/Stuff/HW1/BayesLogit/results/blr_res_%d.csv",fileno+1000),
	row.names=FALSE,col.names=FALSE,sep=",")
